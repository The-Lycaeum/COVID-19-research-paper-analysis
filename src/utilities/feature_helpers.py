...
## Function for scoring term frequency by sentence
...
## Function for defining a sentence scoring threshold
...
# Pull the scoring & thresholding together to generate a summary sentence
